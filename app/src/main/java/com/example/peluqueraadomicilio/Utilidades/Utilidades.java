...
public class Utilidades {
   ...
   public static final String CREAR_TABLA_USUARIO = "CREATE TABLE "+TABLA_USUARIO+ " (" + CAMPO_ID +" INTEGER PRIMARY KEY AUTOINCREMENT, "  + CAMPO_USUARIO +" TEXT, " + CAMPO_CONTRASENA + " TEXT," + CAMPO_NOMBRE_DUENO + " TEXT," + CAMPO_MAIL + " TEXT," + CAMPO_DOMICILIO + " TEXT, " + CAMPO_LOCALIDAD + " TEXT, " + CAMPO_CELULAR +  " TEXT)";
